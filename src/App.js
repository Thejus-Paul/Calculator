  ...
  return (
    <div className="App">
      ...
      <div className="inputs__row row--1">
          <button className="btn" id="clear" onClick={backspace.bind(this)} aria-label="Backspace">
